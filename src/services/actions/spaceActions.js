...
// const baseURL = 'https://www.spenserbrinkman.com/greenhouse/api/spaces/'

const baseURL = (process.env.NODE_ENV === 'production' ? 'https://www.spenserbrinkman.com/greenhouse/api/spaces/' : 'http://localhost:3001/spaces/')
