...
// const baseURL = 'https://www.spenserbrinkman.com/greenhouse/api/plants/'

const baseURL = (process.env.NODE_ENV === 'production' ? 'https://www.spenserbrinkman.com/greenhouse/api/plants/' : 'http://localhost:3001/plants/')
